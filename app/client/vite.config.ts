...
const serverPort = Number(process.env.INSTANTCOFFEE_OBSERVE_SERVER_PORT || '4981')
const clientPort = Number(process.env.INSTANTCOFFEE_OBSERVE_DEV_CLIENT_PORT || '5174')
...
export default defineConfig({
  define: {
    ...
    __GITHUB_REPO_URL__: JSON.stringify(process.env.INSTANTCOFFEE_OBSERVE_GITHUB_REPO_URL || rootPkg.repository || ''),
  },
