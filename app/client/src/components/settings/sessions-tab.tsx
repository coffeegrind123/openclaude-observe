...
type SortBy = 'status' | 'activity' | 'created' | 'events'
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-md border">
        <div className="grid grid-cols-[auto_1fr_95px_95px_55px_28px] items-center gap-3 px-3 py-2 text-xs font-medium text-muted-foreground border-b bg-muted/30">
          <Checkbox
...
function SessionRow({
  ...
  return (
    ...
    <label className="grid grid-cols-[auto_1fr_95px_95px_55px_28px] gap-x-3 gap-y-0.5 px-3 py-2 border-b last:border-b-0 text-sm hover:bg-muted/30 cursor-pointer">
      ...
      <div className="col-start-2 col-span-4 min-w-0 flex items-baseline gap-1 text-xs text-muted-foreground">
        <button
          type="button"
          onClick={(e) => {
            e.preventDefault()
