...
describe('ui-store', () => {
  ...
  describe('hash parsing and URL sync', () => {
    ...
    it('should update hash when setting project', () => {
    ...
    it('should update hash when setting session', () => {
      ...
      expect(window.location.hash).toBe('#/proj-1/sess-1')
    })
    ...
    it('should clear session when a new project is selected', () => {
      useUIStore.getState().setSelectedProjectId('proj-1')
      useUIStore.getState().setSelectedSessionId('sess-1')
      useUIStore.getState().setSelectedProjectId('proj-2')
      expect(useUIStore.getState().selectedSessionId).toBeNull()
      expect(window.location.hash).toBe('#/proj-2')
    })
  })
