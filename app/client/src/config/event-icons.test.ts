...
vi.mock('lucide-react/dynamicIconImports', () => {
  ...
  const names = [
    'Rocket', 'Flag', 'MessageSquare', 'Zap', 'BookOpen', 'Pencil', 'FilePen',
    'SearchCode', 'Plug', 'Wrench', 'CircleCheck', 'CircleX', 'CircleStop',
    'Brain', 'Bell', 'Minimize', 'Bot', 'Pin', 'pin',
  ]
...
vi.mock('@/lib/event-icon-registry', () => {
  const TEST_REGISTRY = [
    ...
    { id: 'Notification', icon: 'Bell', defaultColor: 'BLUE', name: 'Notification', group: 'System' },
...
describe('getEventIcon', () => {
  ...
  it('should resolve icons for all known registry subtypes', () => {
    const nonToolSubtypes = [
      ...
      'LLMGeneration', 'Notification', 'PreCompact', 'SubagentStart',
    ]
